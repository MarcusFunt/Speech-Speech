...
from local_assistant.dev import find_free_port, ollama_health_urls, port_is_free
...
def test_ollama_health_urls_include_openai_and_native_endpoints():
    assert ollama_health_urls("http://localhost:11434/v1") == [
